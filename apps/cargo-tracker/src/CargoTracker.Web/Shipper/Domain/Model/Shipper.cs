...
public sealed class Shipper : AggregateRoot
{
    ...
    private Shipper(
        ShipperId id, ShipperCode code, ShipperName name, Email email, Phone? phone,
    ...
    public static Shipper RegisterIndividual(ShipperName name, Email email, Phone? phone)
    {
        var shipper = new Shipper(
            ShipperId.New(), ShipperCode.Generate(), name, email, phone,
    ...
    public static Shipper Reconstruct(
        ShipperId id, ShipperCode code, ShipperName name, Email email, Phone? phone,
        ShipperType type, ContractNumber? contractNumber, DiscountRate discountRate, long version)
        => new(id, code, name, email, phone, type, contractNumber, discountRate, version);
}
