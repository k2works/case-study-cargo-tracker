...
public class Cargo {
     ...
     *
     * <p><strong>3 つとも「引取」という 1 つの出来事を指す</strong>ため、
     * 1 つの値オブジェクトにまとめている（IT19 の D1）。中身の意味は
     * {@link CargoClaim} に書いてある。
     */
    ...
    public Cargo withConsignee(Consignee restored) {
        this.claim = claim.withConsignee(restored);
        return this;
    }
    ...
    public void registerConsignee(Consignee newConsignee) {
        ...
        this.claim = claim.withConsignee(newConsignee);
    }

    /** 荷受人。未登録なら {@code null}。 */
    public Consignee consignee() {
        return claim.consignee();
    }
