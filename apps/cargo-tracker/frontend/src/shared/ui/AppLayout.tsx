 ...
 *
 * <p>タブは 3 つ（IT12 で 1 つ増やした）。<b>船から降ろす仕事（作業のある航海）、
 * 降りたあとの仕事（引取待ち）、そして通関</b>である。どちらの航海の仕事でもない
 * 引取は航海起点では出てこない。<b>通関の申告は荷役作業員が出す</b>ので、
 * その入口が無いとモバイル幅から辿り着けない（ui_design.md）。</p>
 */
const HANDLER_TABS = [
  { path: '/', label: '作業のある航海' },
  { path: '/handling/awaiting-claim', label: '引取待ち' },
  { path: '/customs', label: '通関' },
] as const;
