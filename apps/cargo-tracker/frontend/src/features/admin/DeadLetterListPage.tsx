  ...
  return (
    <section>
      ...
      <p className="mt-1 text-sm text-gray-600">
        {/* **強調のまわりで行を折らない。** JSX の改行が空白になるかどうかは
            読み手にも静的解析にも曖昧で、日本語では空白を入れたくない。 */}
        投影や連鎖が書けなかったイベントです。<b>1 件で全部が止まらないように</b>退避先へ逃がしています。<b>原因を直してから処理し直してください</b>——直っていなければ、また退避されます。
      </p>
