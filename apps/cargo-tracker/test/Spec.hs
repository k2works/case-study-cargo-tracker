...
import qualified Billing.Infrastructure.PostgresInvoiceRepositorySpec
...
import qualified Shared.Infrastructure.LoggingSpec
...
import qualified Tracking.Interfaces.ManualUpdatePageApiSpec
...
main = hspec $ do
  ...
  describe
    "Cargotracker.Shared.Infrastructure.Logging"
    Shared.Infrastructure.LoggingSpec.spec
  ...
  describe
    "Cargotracker.Tracking.Interfaces.ManualUpdatePageApi"
    Tracking.Interfaces.ManualUpdatePageApiSpec.spec
  ...
  describe
    "Cargotracker.Pricing.Domain.Model.Value.Cost"
    Pricing.Domain.Model.Value.CostSpec.spec

  describe
    "Cargotracker.Pricing.Domain.Model.PricingRule"
    Pricing.Domain.Model.PricingRuleSpec.spec
  ...
  describe
    ...
    Pricing.Domain.Model.Value.CurrencyRateSpec.spec
  ...
  describe
    "Cargotracker.Pricing.Interfaces.CostCalculationPageApi"
    Pricing.Interfaces.CostCalculationPageApiSpec.spec
  ...
  describe
    ...
    Notification.Application.SendClaimNotificationCommandSpec.spec
  ...
  describe
    "Cargotracker.Notification.Interfaces.NotificationListPageApi"
    Notification.Interfaces.NotificationListPageApiSpec.spec
  ...
  describe
    "Cargotracker.Exception.Domain.Model (Amount + Damage + Loss + ExceptionType)"
    Exception.Domain.Model.ExceptionTypeSpec.spec

  describe
    "Cargotracker.Exception.Domain.Model (Reporter + ExceptionRecord aggregate)"
    Exception.Domain.Model.ExceptionRecordSpec.spec

  describe
    "Cargotracker.Exception.Application.RecordDelayExceptionCommand"
    Exception.Application.RecordDelayExceptionCommandSpec.spec
  ...
  describe
    "Cargotracker.Billing.Application (US23 コマンド)"
    Billing.Application.BillingCommandsSpec.spec
  ...
  describe
    "Cargotracker.Billing.Infrastructure.PostgresInvoiceRepository (統合)"
    Billing.Infrastructure.PostgresInvoiceRepositorySpec.spec
