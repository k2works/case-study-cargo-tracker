 ...
 */
public record TrackingException(Long id, ExceptionType exceptionType, String description,
    ...
    public static TrackingException raise(ExceptionType exceptionType, String description,
            Instant occurredAt) {
        return new TrackingException(null, exceptionType, description, occurredAt, null, null);
    }

    /** 永続化された行から復元する。ここでは検査しない。 */
    public static TrackingException restore(Long id, ExceptionType exceptionType,
            String description, Instant occurredAt, Instant resolvedAt, String resolutionNotes) {
        return new TrackingException(id, exceptionType, description, occurredAt, resolvedAt,
                resolutionNotes);
    }
     ...
     */
    public TrackingException resolve(String notes, Instant resolvedAt) {
        ...
        return new TrackingException(id, exceptionType, description, occurredAt, resolvedAt, notes);
    }
}
