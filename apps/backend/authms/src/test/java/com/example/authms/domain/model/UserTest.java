...
class UserTest {
    ...
    private User active() {
        return User.restore(
                1L, new UserIdentity("sales01", "sales@example.com", "テスト利用者", "hashed"), true, LoginState.clean(), Set.of(Role.ROLE_SALES));
    }
    ...
    class Availability {
        ...
        void rejectsDisabledUser() {
            User disabled = User.restore(
                1L, new UserIdentity("sales01", "s@example.com", "テスト利用者", "hashed"), false, LoginState.clean(), Set.of(Role.ROLE_SALES));
        ...
        void rejectsWhileLocked() {
            User locked = User.restore(
                1L, new UserIdentity("s", "s@example.com", "テスト利用者", "h"), true, new LoginState(5, NOW.plusSeconds(60)), Set.of(Role.ROLE_SALES));
        ...
        void acceptsAfterLockExpires() {
            User expired = User.restore(
                1L, new UserIdentity("s", "s@example.com", "テスト利用者", "h"), true, new LoginState(5, NOW.minusSeconds(1)), Set.of(Role.ROLE_SALES));
        ...
        void stillLockedAtBoundary() {
            User boundary =
                    User.restore(
                1L, new UserIdentity("s", "s@example.com", "テスト利用者", "h"), true, new LoginState(5, NOW), Set.of(Role.ROLE_SALES));
    ...
    class Restoration {
        ...
        void keepsRoles() {
            User multiRole = User.restore(
                1L, new UserIdentity("u", "u@example.com", "テスト利用者", "h"), true, LoginState.clean(),
        ...
        void restoresUserWithoutRoles() {
            ...
            User noRole = User.restore(
                1L, new UserIdentity("u", "u@example.com", "テスト利用者", "h"), true, LoginState.clean(), Set.of());
