...
| ドキュメント | 概要 | 状況 |
| :--- | :--- | :--- |
| [アプリケーション開発環境セットアップ手順書](アプリケーション開発環境セットアップ手順書.md) | ローカル開発環境の構築手順（Java 25 / Axon 5 / MyBatis / 7 マイクロサービス + React SPA / PostgreSQL / Axon Server） | 作成済み |
| [開発環境セットアップ手順書](開発環境セットアップ手順書.md) | 開発環境のインフラ構築手順（Heroku + Axon ローカルバス + H2） | 作成済み |

### 廃止管理

| ドキュメント | 概要 | 状況 |
| :--- | :--- | :--- |
| [Deprecation 一覧](Deprecation一覧.md) | 廃止予定 API・コード・設定の一覧と移行計画 | 作成済み |
