...
2026-07-01 to 2027-03-31 are named [年次運用期間]
[年次: DR 訓練（リージョン障害シミュレーション）] lasts 270 days
[年次: ライセンス更新確認] lasts 270 days
[年次: 監査ログレビュー] lasts 270 days
[年次: 非機能要件の見直し] lasts 270 days
@endgantt
```
