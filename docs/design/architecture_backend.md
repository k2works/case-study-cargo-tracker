...
| `GET` | `/api/v1/bookings/{bookingId}/route` | 確定旅程を構成する輸送区間（cargo_leg）のリスト取得（US11/US12 経路表示） | UC09 |
| `POST` | `/api/v1/bookings/{bookingId}/notify-route` | 確定経路の荷主通知（NotifyRouteToShipperCommand、route_notified_at を記録、US12） | UC10 |
