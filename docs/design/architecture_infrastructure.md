...
コンテナ化された Spring Boot アプリケーションを **AWS ECS Fargate** 上で稼働させ、
...
[cargo-tracker-app\n(Spring Boot)\nport: 8080] --> [postgres:16-alpine\nport: 5432\nvolume: postgres_data] : SPRING_DATASOURCE_URL
...
[Spring Boot\n(Actuator + Logback)] --> [CloudWatch Logs\n(/ecs/cargo-tracker)] : awslogs ドライバー
