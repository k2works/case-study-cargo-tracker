...
{+
  ...
  {#
    **予約番号** | **荷主** | **出発地** | **目的地** | **到着期限** | **貨物種別** | **重量** | **状態**
    ...
    BK-11111111  | 佐藤商事（SHP-11111111） | JPYOK | GBFXT | 2026-04-20 | 冷凍貨物 | 800 kg | <color:green>確認済</color>
...
| 現在割り当てられている経路の表示 | ❌ | ❌ | 選び直しの判断に要る（IT9 レビュー M10。IT10 へ） |
| 並べ替え・表示件数の上限 | ❌ | ❌ | 候補が 20〜30 件になると目視では回らない（IT9 レビュー M11。IT10 へ） |
