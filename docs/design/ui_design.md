...
| S15 | 追跡照会（公開） | `/tracking/:trackingNumber` | UC15 | 荷主・荷受人 | シングル |
...
{+
  ...
  ---
  例外種別 | "(.) 遅延  ( ) 破損  ( ) 紛失"
  発生日時 | "2026-06-05 14:00"
  発生場所 (UN/LOCODE) | "SGSIN"
  詳細 | "...."
  ---
  {(紛失選択時)
    ⚠ 紛失を選択しました。
    管理職への escalation 通知が送信されます。
  }
  ---
  [登録] | [キャンセル]
}
