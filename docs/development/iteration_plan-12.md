...
- [x] CI が緑・SonarQube Quality Gate が **PASS**（Bug 0 / Vulnerability 0 / Code Smell 0 / 重複 0.3% / 新規コードのカバレッジ 87.4%）
...
- [x] キャプチャを生成 spec で再生成（既存 20 枚＋新規 2 枚）。**引取確認コード・通関の行・荷主の紐付け・新しいナビ項目が図に入った**
...
- [x] **Release 1.1 全体の未達・部分的な項目を完了報告書に名前で残した**（未達のストーリーは無し。**意図的に範囲を絞った 6 項目**を名前で記録）
