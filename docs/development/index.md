...
| IT7 | [計画](./iteration_plan-7.md) | [ふりかえり](./retrospective-7.md) | - | 完了（Java テスト全パス・E2E +8 件・カバレッジ 81.7%・US14・US15 完了） |
| IT8 | - | - | - | 未着手（US16・US18・US17 + IT7-改善） |
| IT9 | - | - | - | 未着手（US19・US20） |
...
| Phase 2 | 経路設計・追跡 | 44 | 36 | 進行中（IT3-5: US01・US06-US11 完了、IT7: US14・US15 完了、US16・US18: IT8 で実施） |
| Phase 3 | 精算・例外処理 | 26 | 8 | 進行中（IT6: US22・US23 完了、US17・US19-US21: IT8-10 で実施） |
