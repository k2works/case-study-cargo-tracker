...
| IT3（2026-06-11〜06-24） | [iteration_plan-3.md](./iteration_plan-3.md) | - | - | 実装中（US25 / US01 / US06 / IT2 持越し完了、US07 5 SP 残、進捗 11/16 SP 69%） |
...
| Phase 1 | 予約・経路設計コア（IT1〜IT4） | 57 | 28（IT3 進行中分含む） | 進行中（IT3 US07 残） |
