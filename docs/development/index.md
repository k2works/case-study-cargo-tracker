...
| IT20 | [計画](iteration_plan-20.md) | [ふりかえり](retrospective-20.md) | [報告書](iteration_report-20.md) | **完了**（2026-08-13。出荷と是正 2 回目。**育つ負債 2 件を返済**し、正典に 2 リリース残っていた未判断 5 件を決着（ADR-025）。SP 0） |
...
| IT20 | 0 | 0 | **完了**（育つ負債 2 件・正典の未判断 5 件・U4〜U8・レビュー高 10 件） |
| **累計（完了分）** | **117** | **117** | **100%** |
