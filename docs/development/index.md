...
| IT7 | [計画](./iteration_plan-7.md) | [ふりかえり](./retrospective-7.md) | [完了報告書](./iteration_report-7.md) | **完了**（11/11 SP・縮退 0 件） |
...
| IT12 | [計画](./iteration_plan-12.md) | [ふりかえり](./retrospective-12.md) | [完了報告書](./iteration_report-12.md) | **完了**（11/11 SP・縮退 0 件）。**v1.0.0 完了** |
...
| Phase 4 | 荷役と追跡（IT10-12） | 26 | 26 | **完了**（IT12 完了） |
| Phase 5 | 精算 | 13 | 0 | **スコープ外**（ADR-0007） |
| **合計** | | **160** | **127** | 残 33 SP |

> **フェーズの区切りとイテレーションの対応は
> [リリース計画](release_plan.md)が正典です**。IT8 計画時に
> Phase 3 を IT4-9、Phase 4 を IT10-12 へ改訂しましたが、
> 本表が IT4-7 / IT8-9 のまま止まっていました（IT9 クローズ時に是正）。
...
| v0.1.0 基盤と公開追跡 | - | 未着手 |
| v0.2.0 予約と経路設計 | - | 未着手 |
| v1.0.0 全業務フロー | [完了報告書](./release_report-1_0_0.md) | **完了**（2026-08-06・タグ `flix/take-1/v1.0.0`） |
