...
| IT5（US14・15・16, 11SP） | [iteration_plan-5.md](./iteration_plan-5.md) | [retrospective-5.md](./retrospective-5.md) | — | 完了 ✅ |
...
| フェーズ | 内容 | SP | 完了 SP | 状態 |
|---------|------|-----|---------|------|
| Phase 1 | コア輸送管理（US01〜US15） | 51 | 48 | 進行中（US14・US15 残り → IT5） |
