...
> - **達成率 100%**: 拡張計画 18 SP に対する実績 18 SP
> - **達成率 180%**: 当初本体目標 10 SP に対する実績 18 SP (Try 込み)
>
> 本ドキュメントの「IT2 = 22」は arch-check Rule 4 を横断 Try に含めた数値。`retrospective-2.md` / `release_plan.md` の「18 SP / 180%」と数学的に整合する (10 本体 + 8 Try = 18、+ 2 横断 = 22)。
