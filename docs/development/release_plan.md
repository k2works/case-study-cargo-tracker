...
| IT | ゴール | 対象 | 計画 SP |
|:--:|-------|------|:---:|
| IT5 | 危険物・冷凍貨物と経路設計への引き渡し、見積 | US05, US06, US01, US07 | 13 |
...
xychart-beta
    ...
    line "実績" [148, 132, 115, 101, 101, 101, 101, 101, 101, 101, 101]
```

実績線は IT3 まで（残 101 SP。TS08 の 3 SP を含む）。IT4 以降は未着手のため横引きしています。
