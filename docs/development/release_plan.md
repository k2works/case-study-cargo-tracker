...
| Release 2.3 | 締めの仕上げとシミュレーションの後始末 | 1 + 負債 3 件 | 8 |
| **合計** | | **38** | **134** |

> **合計は明細から導きます。手で持つと必ずずれます**（take-6 の教訓）。
> 突き合わせる相手は明細ではなく **US の全件（US01〜US38）** です。全 33 件がいずれかのリリースに属することを、リリース変更のたびに確認してください。
...
| IT16 | 8（US38 3 + TD-02 2 + TD-03 2 + TD-04 1） | - | - | [計画済み](iteration_plan-16.md) |
