...
| IT7 | 10 | - | - | [計画済み](iteration_plan-7.md) |
| IT8 | 9 | - | - | 未着手 |
| IT9 | 10 | - | - | 未着手 |
| IT10 | 7 | - | - | 未着手 |
| IT11 | 9 | - | - | 未着手 |
...
xychart-beta
    ...
    line "実績" [105, 96, 88, 78, 70, 62, 53]
```

> **実績が計画と一致しています（IT1〜IT6 で 52 SP／計画どおり）。** ただしこれは
> 「見積もりが当たった」ことのみを意味し、余力の有無は示しません。IT3 は高優先度 10 件、
> IT4 は 14 件、IT5 は 12 件、**IT6 は 9 件**のレビュー手直しが発生しています。
>
