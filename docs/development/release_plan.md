...
gantt
    ...
    dateFormat  YYYY-MM-DD
    section Phase 1
    IT1 荷主・予約基盤（完了）  :done, a1, 2026-04-07, 14d
    IT2 IT1改善完了・US05/US13進行中 :active, a2, 2026-04-21, 14d
```
...
| 2 | 10 | 4 | 40% | 進行中（IT1 品質改善 4 SP 完了、テスト 95 件全 Green、カバレッジ 63%） |
| 3 | 20 | - | - | 未着手 |
| 4 | 24 | - | - | 未着手 |
| 5 | 18 | - | - | 未着手 |
| 6 | 8 | - | - | 未着手 |
...
1. IT2 残りタスクを実施する（US05: 危険物・冷凍貨物予約、US13: 予約確定）
2. IT2 完了後にふりかえり・報告書を作成する
