...
| **累計** | **152**（145 + TS08 3 + TS09 3 + TS10 1） | **59** | **39%** | |
...
xychart-beta
    ...
    y-axis "残 SP" 0 --> 145
    line "計画" [148, 132, 115, 101, 87, 74, 63, 50, 37, 24, 13]
    line "実績" [148, 132, 115, 101, 89, 89, 89, 89, 89, 89, 89]
```

実績線は IT4 まで（残 89 SP）。IT5 以降は未着手のため横引きしています。
**IT10 終了時点で残 13 SP（Phase 5）が残る計画**であり、この扱いを IT6 終了時に判断します。
IT4 の未達 2 SP（US04 の受入基準の欠落・TS05b の E2E）は IT5 へ繰り越します。
