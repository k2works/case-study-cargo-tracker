...
1. **Release 2.1 完了報告書を作成する**（入力は [IT13 完了報告書](iteration_report-13.md)・[IT13 ふりかえり](retrospective-13.md)・[IT13 レビュー](../review/イテレーション13_review_20260828.md)）。
2. Release 2.2 を計画するなら、**3 度目・4 度目の申し送りを SP 付きのタスクで置く**——請求書検索（3 度目）・SonarQube Hotspot の走査トークン権限（4 度目）。詳細は [IT13 ふりかえり](retrospective-13.md)の引き継ぎ表。
