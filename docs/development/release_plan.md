...
gantt
    ...
    IT6 IT5-改善・法人割引・精算処理（進行中） :active, a6, 2026-04-10, 10d
```
...
**目標 SP**: 10 / **実績 SP**: 3（進行中、IT5-改善 3 SP 完了）
...
| 6 | 10 | 3 | 30% | 進行中（IT5-改善 3 SP 完了・US22・US23 未着手） |
...
5. IT6 ふりかえり・完了報告書を作成する（`planning-releases --retrospective`・`planning-releases --report`）
