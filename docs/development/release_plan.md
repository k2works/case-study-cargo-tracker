...
| IT4 経路確定・予約確定 | 12 | 12 | 開発完了 | US09/US10/US11/US12/US13 完了。経路確定〜予約確定を縦貫通（候補選択・確定/期限再算出/荷主通知/予約確定・差し戻し・キャンセル）。ADR-0010 起票・RouteAcl。全 242 テスト緑・カバレッジ 全体94.1%/ドメイン90.2%。post-commit dispatch を結線（retro-3 Try#1 解消）・IT3 M1 リファクタ消化 |
| IT5 追跡・荷役 | 17 | 17 | 開発完了 | US14/US15/US16/US17/US18 完了。Tracking/Handling を縦貫通（追跡番号自動発行・荷役/引取・手動更新・照会・公開ページ）。BC 間イベント連携（retro-4 Try#1）・ADR-0002 改訂で決着。全 307 テスト緑・カバレッジ 全体91.3%/ドメイン89.1%。予約確定→追跡照会の E2E 一気通貫。**Release 1.0 MVP のフロー完成** |
| IT6 例外対応 | 6 | 6 | 開発完了 | US19/US20 完了。例外（遅延・破損・紛失）を全層縦貫通（登録→InException 導出→荷主通知→Lost エスカレーション→対応報告→解決復帰）。マイグレーション 0011・ADR-0011/0012 起票。IT5 レビュー IT6 送り（高2・中6）と retro-5 Try#1/#4 を全消化。全 340 テスト緑・カバレッジ 全体91.6%/ドメイン89.7% |
| IT7 割引ポリシー・請求・精算 | 16 | 16 | 開発完了 | US-ADM-01/US21/US22/US23 完了。Billing コンテキストを新規立ち上げ（Money 銀行家丸め・DiscountRate・PaymentState DU・料金算出・法人割引・精算・入金確認）。BookingState に Delivered/Settled 段階追加。ADR-0013 起票。全 375 テスト緑・カバレッジ 全体90.6%/ドメイン89.7%。Release 1.1 全体フロー E2E 一気通貫 |
...
**目標 SP**: 6（US19/20）+ Release 1.0 フィードバック対応・retro-5 Try#1/#4
...
|---------------|---------|---------|--------|------|
| IT1 | 10 | 10 | 100% | 開発完了（US01/US02/US03・技術基盤・認証完了。品質ゲートの一部繰り越し） |
| IT2 | 10 | 10 | 100% | 開発完了（US04/US05/US06・ふりかえり済み） |
| IT3 | 14 | 14 | 100% | 開発完了（US24/US25/US07/US08・ふりかえり済み・ベロシティ再較正） |
| IT4 | 12 | 12 | 100% | 開発完了（US09/US10/US11/US12/US13・ふりかえり済み・4 IT 連続 100%） |
| IT5 | 17 | 17 | 100% | 開発完了（US14-18・ふりかえり済み・5 IT 連続 100%・Release 1.0 フロー完成） |
| IT6 | 6 | 6 | 100% | 開発完了（US19/US20・ふりかえり済み・6 IT 連続 100%・Release 1.1 例外対応フロー完成） |
| IT7 | 16 | 16 | 100% | 開発完了（US-ADM-01/US21/US22/US23・ふりかえり済み・7 IT 連続 100%・累計 85/85 SP・Release 1.1 全機能完成） |
| IT8 | 13 | - | - | 計画済み（予備・強化。US21-23/US-ADM-01 受入残＋通知/決済/整合性強化・Release 1.1 出荷品質・iteration_plan-8.md 作成） |
