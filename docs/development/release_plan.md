...
| IT5 | 8 | - | - | [計画済み](iteration_plan-5.md) |
| IT6 | 9 | - | - | 未着手 |
| IT7 | 10 | - | - | 未着手 |
| IT8 | 9 | - | - | 未着手 |
| IT9 | 10 | - | - | 未着手 |
...
xychart-beta
    ...
    line "実績" [105, 96, 88, 78, 70]
```

> **実績が計画と一致しています（IT1〜IT4 で 35 SP／計画どおり）。** ただしこれは
> 「見積もりが当たった」ことのみを意味し、余力の有無は示しません。IT3 は高優先度 10 件、
> IT4 は 14 件のレビュー手直しが発生しており、**その工数は SP に計上されていません**。
> 2 IT 続けて 10 件を超えたため、IT5 は**レビュー手直しの枠を見積もりに入れます**
> （[IT4 ふりかえり](retrospective-4.md)の Try 9）。
