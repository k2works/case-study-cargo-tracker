...
xychart-beta
    ...
    line "実績" [91, 76, 68, 51, 40, 33]
```

> 実績（IT1-7 完了時）: 開始 91 → IT1 -15=76 → IT2 -8=68 → IT3 -17=51 → IT4 -11=40 → IT5 -7=33 → IT6 -14=19 → IT7 -13=6。**Phase 2 完了・Release 0.2 到達**、Phase 3 の例外処理（US17/US19/US20・13SP）完了。残る精算 3 ストーリー（US21 料金算出・US22 法人割引・US23 精算・計 13SP）を IT8 で消化し **Release 1.0（全機能）** へ到達する。
