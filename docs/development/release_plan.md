...
| TS05 | CI/CD パイプライン（PR / main / 日次 / リリース） | 5 | 低 | 中 | 中 | 高 | 必須 |
| **合計** | | **17** | | | | | |
...
| IT7 | 経路確定と追跡番号発行 | US09, US11, US13, US14 | 13 |
...
| 追跡 API のスループット目標（1,000 RPS）が未達 | 中 | 高 | 未検証であることを設計に明記済み。IT7 以降で負荷試験を実施し、キャッシュ導入か目標見直しを判断する |
...
xychart-beta
    ...
    y-axis "残 SP" 0 --> 145
    line "計画" [145, 129, 114, 97, 82, 68, 55, 42, 29, 13, 0]
```
