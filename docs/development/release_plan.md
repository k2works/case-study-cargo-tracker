...
| **開発チーム** | 1 名（AI 支援開発） |
| **技術スタック** | Java 21 → Java 25（Phase 3 移行予定）/ Spring Boot 3.4 → 4.0（ADR-001 参照）/ Thymeleaf / htmx / AWS ECS+RDS |
...
gantt
    ...
    dateFormat  YYYY-MM-DD
    section Phase 1
    IT1 基盤・荷主・予約 (-)      :it1a, 2026-03-31, 14d
    section Phase 2
```
...
|--------------|------|---------|---------|--------|------|
| IT1 | 2026-03-31〜04-13 | 10 | - | - | 計画済 |
| IT2 | 2026-04-14〜04-27 | 10 | - | - | 未着手 |
