...
> 詳細計画: [イテレーション 2 計画](iteration_plan-2.md)（状態: 計画済み）

**ゴール**: 見積作成から貨物予約登録・経路設計者への引き渡しまでの MVP フローを完成させる。

**主なタスク**:

- [ ] US01: 輸送見積作成（ルート候補スタブ）
- [ ] US04/US05: 貨物予約登録（荷受人必須・危険物/冷凍）
- [ ] US06: 経路設計者への引き渡し（ROUTING_IN_PROGRESS）
...
- [ ] US24/US25: 航海スケジュール登録・更新
- [ ] US07: 航海スケジュール検索
- [ ] US08: 経路候補算出（外部経路サービス ACL + nock 契約テスト）
...
- [ ] US09/US10/US11: 経路選択・調整・予約紐付け
- [ ] US12: 荷主通知
- [ ] US13/US14: 予約確定・追跡番号発行
