...
**目標 SP**: 11（本体）+ 12（IT2 繰越 U-01〜U-10）+ 4（推奨 U-11〜U-14）= 27
...
- [ ] US20 (破損・紛失例外処理) を実装
- [ ] US22 (法人割引適用) を実装
- [ ] IT6 繰越 (T6-01 統合 E2E / T6-03 v1.0.0-mvp tag / T6-04 上流補完 / T6-09 AuthProtect 拡張)
- [ ] 保証系: Testcontainers 統合テスト + k6 スモーク CI + katip 正式化

**目標 SP**: 22 (本体 10 + IT6 繰越 6 + 保証系 4 + 上流補完 2)
...
| IT2 | 10 (+Try 8+横断 2) | 18 | 180% (※) | 完了 (2026-06-27、arch-check Phase 2 は IT3 繰越) |

> **(※) ベロシティ表記の統一注記 (H-09)**:
>
> - **180% = 実績 18 / 本体目標 10**: 当初イテレーション計画の本体 4 ストーリー (10 SP) を基準とした達成率。本表で採用
> - **100% = 実績 18 / 拡張計画 18**: 本体 10 + Try 8 (T-01〜T-09 + T-10 HPC) を含めた拡張計画基準。`retrospective-2.md` で採用
> - **22 SP 表記**: arch-check Rule 4 (2 SP) を横断 Try として加算したもの。`iteration_report-2.md` で採用
>
> 3 ドキュメントの数字は数学的に整合する (10 本体 + 8 Try = 18、+ 2 横断 = 22)。表記の違いは分母 (本体目標 / 拡張計画) と横断 Try の含否のみ。
| IT3 | 29 (本体 11 + 繰越 12 + レビュー 2 + 推奨 4 ストレッチ) | 22 (本体 11 + Try 4 + レビュー高優先 5 + 横断 2) | 76% | 完了 (2026-06-29、ストレッチ 7 SP は IT4 繰越、post-nav レビュー H-01〜H-03 即時対応済み) |
| IT4 | 20 (本体 11 + IT3 繰越 7 + 拡張 2) | 19.0 (本体 11 + IT3 繰越 4 + 拡張 1 + UI 補強 3) | 95% | 完了 (2026-06-30、本体 4 ストーリー全 Domain+App+UI 完成、HTTP 結線/Postgres/Playwright/Docker 系 1 SP は IT5 繰越、Ralph Loop 18 反復で消化) |
...
| IT7 | 10 | 30+ (US17/US19/US20/US22 一巡 + Exception BC 新設 + ADR-0013 全 Phase + T6-06 k6 CI + T7-01 UNLOAD→ConfirmationCode 接続 + T6-07 correlation_id + T6-09 RolePolicy/RoleGate + 上流ドキュメント 3 種同期) | 300%+ | 進行中 (2026-07-03、Ralph Loop 65 反復 = 1 週目 iter 1-58 + 2 週目 iter 1-8、T7-01 完了、残: T6-05 Testcontainers / T6-07 katip 完全移行 / T6-09 Servant API 型拡張 + Main.hs 配線) |
| IT8 | 3 (+ストレッチ 5) | - | - | 未着手 |
| IT9 | (予備) | - | - | 未着手 |
| **累計** | **73 + 5** | **109+** | **140%+** | IT1-IT6 完了、IT7 進行中 (Ralph Loop 65 反復消化 = 1 週目 58 + 2 週目 8) |
