...
| IT5 追跡・荷役 | 17 | - | 計画中 | US14/US15/US16/US17/US18（Release 1.0 出荷）。[iteration_plan-5.md](./iteration_plan-5.md) 作成済み。中盤インサイドアウト最終・Tracking/Handling 立ち上げ・BC 間イベント連携（retro-4 Try#1）・ADR-0002 決着。US17 をバッファ調整候補 |
