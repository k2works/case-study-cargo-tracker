...
| 8 | 10 | - | - | 未着手（IT7-改善・US16・US18・US17） |
| 9 | 10 | - | - | 未着手（US19・US20） |
...
5. IT8 計画を作成する → [iteration_plan-8.md](./iteration_plan-8.md) を参照
6. IT8 開発を実行する（IT7-改善・US16・US18・US17）→ Phase 2 完結
7. IT8 ふりかえり・完了報告書を作成する
8. IT9 計画・開発（IT8-改善・US19・US20）→ 例外処理完成
