...
> 詳細計画: [イテレーション 5 計画](iteration_plan-5.md)（状態: 完了） / [ふりかえり](retrospective-5.md) / [完了報告書](iteration_report-5.md)

**ゴール**: 荷役作業の記録と貨物状態管理を実装する。

**主なタスク**:

- [x] US15: 荷役作業記録（妥当性検証・MISROUTED 判定）
- [x] US16: 引取作業記録（通関 CLEARED 前提条件）
- [x] US17: 貨物状態の手動更新
...
> 詳細計画: [イテレーション 6 計画](iteration_plan-6.md)（状態: 完了） / [ふりかえり](retrospective-6.md) / [完了報告書](iteration_report-6.md)

**ゴール**: 追跡照会（公開ページ含む）と例外処理を完成させる（Release 0.8）。

**主なタスク**:

- [x] US18: 追跡照会（認証済み + 公開ページ、htmx ポーリング）
- [x] US19/US20: 遅延・破損・紛失の例外処理

**目標 SP**: 11

### イテレーション 7（Week 13-14）

> 詳細計画: [イテレーション 7 計画](iteration_plan-7.md)（状態: 完了） / [ふりかえり](retrospective-7.md) / [完了報告書](iteration_report-7.md)
