...
1. **IT6 実装開始**: US17（法人割引）→ US18（精算処理）の順で TDD で進める
2. **v0.1.0 リリース準備**: IT5 完了により Phase 1 コア機能（US01〜US15）が全実装。コードレビュー・SonarQube 確認後にリリースタグ付与
3. **IT5 完了報告書**: イテレーション完了報告書とふりかえりを作成する
