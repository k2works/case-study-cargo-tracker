...
| IT | ゴール | 対象 | 計画 SP |
|:--:|-------|------|:---:|
| IT5 | 危険物・冷凍貨物と経路設計への引き渡し、見積 + **IT4 の繰越**（E2E・US04 の受入基準・レビュー指摘 20 件） | US05, US06, US01, US07 | 13 + 繰越 2 |
| IT6 | 航海スケジュールと外部 ACL | US24, US25, TS07 | 11 |
| IT7 | 経路候補算出（Datalog）と経路確定 + **HTTP ランタイムの防御**（セマフォ・タイムアウト）と追跡 API の負荷試験 | US08, US09 | 13 |
...
| IT9 | 13 | - | - | 暫定 |
| IT10 | 11 | - | - | 暫定 |
| （枠外） | 13 | - | - | Phase 5。IT6 終了時に判断 |
| **累計** | **148**（145 + TS08 3） | **59** | **40%** | |
