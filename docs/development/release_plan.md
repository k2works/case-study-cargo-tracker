...
- [ ] IT4-改善: SonarQube Quality Gate 確認・状態ガード抽出・ナビ順序変更
- [ ] US09: 経路を選択・確定する
- [ ] US10: 経路条件を調整して再算出する
- [ ] US11: 経路情報を予約に紐付ける
...
2. GitHub Project に同期する（完了）
3. IT5 計画を作成する（完了）→ [iteration_plan-5.md](./iteration_plan-5.md) を参照
4. IT5 開発を開始する（`orchestrating-development`）
