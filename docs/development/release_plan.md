...
| 3 | 10 | - | - | 計画済み（IT2改善 3 + US01 5 + US06 2） |
| 4 | 10 | - | - | 未着手 |
| 5 | 10 | - | - | 未着手 |
| 6 | 10 | - | - | 未着手 |
...
1. IT3 を開始する（IT2改善・US01: 輸送見積作成・US06: 予約情報引き渡し）—— [iteration_plan-3.md](./iteration_plan-3.md) 参照
2. IT3 計画をドキュメント化する（`planning-releases --iteration 3`）
