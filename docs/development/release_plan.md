...
gantt
    ...
    section Phase 3 (見積・荷主)
    IT10 (完了)                   :done, a10, after a9, 1d
    Release 1.0.0                 :milestone, ma3, after a10, 0d
```
...
- [x] US01: 輸送見積を作成する（10 SP）
- [x] US02: 荷主を登録する（6 SP）
- [x] US03: 法人荷主を登録する（5 SP）
...
xychart-beta
    ...
    line "実績" [194, 160, 136, 118, 97, 75, 57, 33, 17, 0, 0]
```
...
1. Release 1.0.0 タグ作成・CHANGELOG 更新
2. プロジェクト完了報告書の作成
...
| 2026-05-12 | IT10 完了: 21 SP / 100%。輸送見積（US01）・荷主登録（US02）・法人荷主登録（US03）BE + FE 実装完了。Phase 3 完了。全 25 US 完了 | - |
