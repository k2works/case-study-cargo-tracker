...
| IT13 料金算出・割引 | [計画](iteration_plan-13.md) | — | — | **計画済み**（8 SP + 引き継ぎ枠 2 + 負債枠 2）。US21 輸送料金を算出する / US22 法人割引を適用する。**Release 2.0 の最初**——billingms が初めて集約を持つ。引取済の予約から請求書ができ、法人割引が入り、輸出は免税になる。例外は根拠を指してから調整する |
| IT13〜IT15 | 未作成 | — | — | 未着手 |
