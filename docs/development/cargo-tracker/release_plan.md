...
| IT11 | 10 | — | — | **計画済み**（[計画](iteration_plan-11.md)）。US20・US28。**終盤の最初**。引き継ぎ枠 A（`CargoDeliveredEvent` の補償）・B（例外中に届いた荷役の再適用）と負債枠を序盤で消化する。**10 SP は直近 3 IT の平均 7.3 を超える**ので、溢れたときの切り落とし順を計画に明記した |
| IT12〜IT15 | 28 | — | — | 未着手 |
