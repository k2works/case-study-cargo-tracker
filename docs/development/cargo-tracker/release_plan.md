...
| IT13 | 8 | — | — | **計画済み**（[計画](iteration_plan-13.md)）。US21 輸送料金を算出する・US22 法人割引を適用する。引き継ぎ枠 2（退避からの再処理入口・処理の列の分割）+ 負債枠 2（受け入れフィクスチャの固定日付・スキーマ 2 件） |
| IT14〜IT15 | 14 | — | — | 未着手 |
| **累計** | **122** | **100** | **100%**（IT1〜IT12 の 100 SP に対して） | |
