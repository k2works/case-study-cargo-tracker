...
| :--- | :--: | :--: | :--: | :--- |
| IT1 | 9 | — | — | **計画済み**（[計画](iteration_plan-1.md)） |
| IT2〜IT15 | 111 | — | — | 未着手 |
| **累計** | **120** | **0** | **—** | |

## 次のステップ

1. [開発戦略](development_strategy.md) で局面と TDD アプローチを確認する
2. `iteration_plan-1.md` の内容を `validating-iteration-plan` で設計と突き合わせる
3. `syncing-github-project` で Issue と Milestone に同期する
4. IT1 のスパイク（ADR-0001 決定 5 の 7 項目）から着手する
...
- [イテレーション計画 1](iteration_plan-1.md)
