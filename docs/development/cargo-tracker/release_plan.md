...
| IT9 | 7 | — | — | **計画済み**（[計画](iteration_plan-9.md)）。US15。IT8 引き継ぎ枠 3 件 + 予備枠 1（ADR-0008 の返済）。**handlingms が動き出す**。**着手前の検証で高 3 件**——`cargo_snapshot` の元イベントが購読不能・bookingms 側の反応がタスクに無い・予備枠の所在が 3 文書で食い違い |
| IT10〜IT15 | 45 | — | — | 未着手 |
| **累計** | **122** | **70** | **100%**（IT1〜IT8 の 70 SP に対して） | |
