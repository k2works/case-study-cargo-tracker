...
[リリース計画](release_plan.md) で確定した IT1〜IT11 を **序盤・中盤・終盤** の 3 局面に分け、各局面で採用する TDD アプローチと横断的な進め方を定義します。
...
| **終盤** | IT7〜IT11 | アウトサイドイン | 既存ドメインを業務シナリオ起点で結合し、リリース全体の一貫性を担保する |
