...
[リリース計画](release_plan.md) で確定した IT1〜IT16 を **序盤・中盤・終盤・精算・整流** の 5 局面に分け、各局面で採用する TDD アプローチと横断的な進め方を定義します。
...
| **整流** | IT16 | アウトサイドイン | **新規ストーリーを作らない局面である。** 未達の受入基準を現場に届け、**宣言した規則に検査を与える**（下記） |
