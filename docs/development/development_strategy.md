...
[リリース計画](release_plan.md) で確定した IT1〜IT19 を **序盤・中盤・終盤・精算・整流・見積・出荷と是正** の 7 局面に分け、各局面で採用する TDD アプローチと横断的な進め方を定義します。
...
| **出荷と是正** | IT19 | アウトサイドイン | **全 36 US が実装完了した後の局面である。** Release 2.1 を出荷として確定させ、**正典に届いていない実装**を返す（下記） |
