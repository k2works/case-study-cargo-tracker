...
- [ ] **ArchUnit のルール 1・2・3 が有効化され、違反を検出できることを確認済み**
...
- [ ] 必須境界値ケースが網羅されている
- [ ] 対象 US の受け入れ基準がすべて緑
- [ ] **ArchUnit のルール 4・6（BC 分離・共有カーネルの範囲）が有効化されている**
...
| ArchUnit ルール 4・6（BC 分離・共有カーネル） | **IT3** | 2 つ目以降の BC が実装されて初めて検査対象ができる |
