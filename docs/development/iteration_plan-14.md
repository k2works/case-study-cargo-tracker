...
| 局面 | **新リリースの立ち上げ・アウトサイドイン**（[開発戦略](development_strategy.md)） |
...
| # | タスク | 見積 | 状態 |
| :--- | :--- | :--- | :--- |
| 6.1 | `domain-model.md`・`data-model.md`・`ui_design.md` に simulationms と実行記録を反映する | 6h | [ ] |
