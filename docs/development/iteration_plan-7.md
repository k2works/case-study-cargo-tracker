...
- [~] **繰り越し品質ゲートの決着（4 IT 連続繰り越しを止める）**: SonarQube SQ-3（S6853 33→0）/SQ-2（S6967 8→1）・セキュリティホットスポット（3→0 SAFE レビュー）は決着（Bug 0・脆弱性 0・全評価 A・重複 1.0%）。Playwright E2E・カバレッジ CI ハードゲートは環境操作（ブラウザ/CI パイプライン）前提で繰り越し。ドメイン被覆は Invoice 95.2%/Money 86.7% を実測
