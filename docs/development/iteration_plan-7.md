...
| T6-03 | v1.0.0-mvp git tag + CHANGELOG `[Unreleased]` → `[1.0.0-mvp]` セクション切出し | 0.5 | 必須 |
| T6-04 | domain-model.md / data-model.md / ui_design.md へ Pricing / Notification 追記 | 1.5 | 必須 |
...
| 1.2 | v1.0.0-mvp git tag 作成 + CHANGELOG セクション切出し | 2h | [ ] |
| 1.3 | domain-model.md へ Pricing (Cost/PricingRule/CurrencyRate/Discount) 追記 | 2h | [ ] |
| 1.4 | domain-model.md へ Notification (Notification 集約/Channel/Content) 追記 | 2h | [ ] |
| 1.5 | data-model.md へ pricing_rule / currency_rate / notification テーブル追記 | 1h | [ ] |
| 1.6 | ui_design.md へ CostCalculationView / NotificationListView 画面遷移追記 | 1h | [ ] |
...
| # | タスク | 見積 | 状態 |
|---|-------|------|------|
| 5.1 | Tracking 集約に `updateStateManually` メソッド + StateChangeAudit VO 追加 | 2h | [ ] |
| 5.2 | ManualStateUpdateCommand (Role: Tracker/Admin 限定、監査ログ書込み) | 2h | [ ] |
...
| # | タスク | 見積 | 状態 |
|---|-------|------|------|
| 6.1 | Shipper 集約に `discountRate` 属性 + CorporateDiscount VO 追加 | 2h | [ ] |
