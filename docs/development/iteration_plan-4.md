...
| 6.8 | IT3 レビュー H2: 経路候補 → US09 経路選択導線を実装（本 IT で解消。IT3 で置いた「IT4 対応」注記を実導線へ置換） | 1h | - | [ ] |
| 6.9 | IT3 レビュー M9: 航海更新（US25）差分の変更箇所ハイライト（左右並置に変更強調）＋M1 状態バッジ日本語化・M2 費用単位/概算表記の UI 一括対応 | 3h | - | [ ] |
...
| カテゴリ | SP | 理想時間 | 状態 |
|---------|----|----|------|
| Day 1 設計反映・局面継続チェック | - | 4h | [ ] |
| US09 経路を選択・確定する | 3 | 16h | [ ] |
| US10 経路条件を調整して再算出する | 3 | 12h | [ ] |
| US11 経路情報を予約に紐付ける | 2 | 12h | [ ] |
| US12 確定経路を荷主に通知する | 2 | 10h | [ ] |
| US13 予約を確定する | 2 | 13h | [ ] |
| IT3 繰り越し・技術的負債・SonarQube・レビュー反映 | - | 25h | [ ] |
| **合計** | **12** | **92h** | |
