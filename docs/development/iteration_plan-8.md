...
| 2.7 | NotificationType に PaymentRequested / PaymentConfirmed / OverdueAlerted 追加、ペイロード + JSON + Flyway V24 (CHECK 拡張) | 3h | [x] **完了 (Flyway V24 のみ次タスク)** (2026-06-24): NotificationType に 3 種追加、NotificationPayload に 3 case class 追加、NotificationPayloadJson に 3 case 追加、BookingPublicApi に logPayment* / logOverdueAlerted の 3 メソッド追加、BookingCommandService に実装。**Flyway V24 CHECK 拡張は次 iteration で対応** |
