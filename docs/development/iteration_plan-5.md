...
| ID | ストーリー | SP | 優先度 | 状態 |
|:--:|-----------|:--:|:---:|------|
| TS09 | 利用者が結果を確認できる状態に戻す（IT4 レビューの返済） | 3 | **最高** | 未着手 |
| US05 | 危険物・冷凍貨物の予約を登録する | 3 | 高 | 未着手 |
| US06 | 予約情報を経路設計者に引き渡す | 2 | 高 | 未着手 |
| TS05b | E2E シナリオと CI ジョブ（IT3 からの持ち越し） | 2 | 高 | 未着手 |
| TS10 | 間欠 403 の原因特定（並行スモークの拡張） | 1 | 中 | 未着手 |
