...
**小計**: 8.5h（理想時間）。`booking.spec.ts` 15 件 PASS（2026-05-25）。
...
| E2E テスト整備（DoD） | 0 | 8.5h | [x] |
| **合計** | **10** | **73.5h** | |

**1 SP あたり**: 約 6.5h

**進捗率**: 100% (10/10 SP) — 2026-05-25: 基盤 + US02 + US03 + US04 + US05 完了。バックエンド 40 + フロントエンド 48 + E2E 15 = 計 103 件 Green。DoD「E2E テスト」も booking.spec.ts で達成。ナビゲーションに荷主管理・予約管理リンクを追加。
