...
**小計**: 7.5h（理想時間）。`booking.spec.ts` 11 件 PASS（2026-05-25）。
...
| E2E テスト整備（DoD） | 0 | 7.5h | [x] |
| **合計** | **10** | **72.5h** | |

**1 SP あたり**: 約 6.5h

**進捗率**: 100% (10/10 SP) — 2026-05-25: 基盤 + US02 + US03 + US04 + US05 完了。バックエンド 40 + フロントエンド 43 + E2E 11 = 計 94 件 Green。DoD「E2E テスト」も booking.spec.ts で達成。
