...
| ID | ユーザーストーリー | SP | 優先度 |
|----|-------------------|----|--------|
| US24 | Release 2.0 GA を本番公開する（新規）| 3 | 必須 |
| US25 | Shipper 法人マスタを UI で登録する（新規・E2E 前提）| 2 | 必須 |
| US23-r1 | 入金消込 CSV 取込 UI（決済機関連携までのブリッジ）| 4 | 必須 |
| US27 | システム監査ログを記録する（audit_log、新規）| 2 | 中 |
| **合計** | | **11** | |
...
### 1. US24 Release 2.0 GA 本番公開（3 SP）
...
### 5. Playwright E2E 4 件（IT8 申し送り T2/T3 統合、SP は US22/US23/US25/US23-r1 内に含む）

| # | タスク | 見積もり | 状態 |
|---|--------|---------|------|
| 5.1 | E2E: US25 法人 Shipper 登録 → US22 法人割引適用 (15% / 30%) → 請求書詳細画面で割引額確認 | 4h | [ ] |
...
|---------|----|----|------|
| 0. IT8 申し送り消化 | 2 | 32h | [ ] |
| 1. US24 Release 2.0 GA | 3 | 12h | [ ] |
| 2. US25 Shipper 法人マスタ UI | 2 | 9h | [ ] |
| 3. US23-r1 CSV 取込 | 4 | 18h | [ ] |
| 4. US27 監査ログ | 2 | 16h | [ ] |
...
| 日 | タスク |
|----|--------|
| Day 6 | US25 法人 Shipper UI (2.1-2.3) |
| Day 7 | US27 監査ログ V29 + Port + Adapter (4.1-4.2) |
| Day 8 | US27 Controller 連携 + 一覧画面 (4.3-4.5) / US23-r1 CSV パーサ + バッチ (3.1-3.2) |
| Day 9 | US23-r1 Controller + 画面 + テスト (3.3-3.5) / E2E 4 件 (5.1-5.4) |
| Day 10 | US24 ステージング → 本番デプロイ → GitHub Release v2.0.0 / リリース後監視 |
...
| 日付 | 更新内容 | 更新者 |
|------|---------|--------|
| 2026-06-24 | IT9 計画初版作成 (US24 GA 公開 + US25 法人 Shipper UI + US23-r1 CSV 取込 + US27 監査ログ + IT8 申し送り 14 件消化、13 SP) | AI Agent |
