...
**ただし、この図のすべてを検証できたわけではありません。** 体制は開発者 1 名であり、ペアリング・共同所有・オンサイト顧客・持続可能なペースは実質的に検証されていません。どのプラクティスに根拠があり、どれに無いかは [シリーズ概要](index.md#この実績で検証できたことできなかったこと) にまとめています。**検証できていないものを、できたかのように書かないためです。**
