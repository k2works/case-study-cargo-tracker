...
class LoginUseCaseTest {
    ...
    void setUp() {
        stored.put("sales01", User.restore(
                1L, new UserIdentity("sales01", "sales@example.com", "テスト利用者", HASH), true, LoginState.clean(), Set.of(Role.ROLE_SALES)));
    }
    ...
    class Failure {
        ...
        void rejectsDisabledUser() {
            stored.put("retired", User.restore(
                2L, new UserIdentity("retired", "r@example.com", "テスト利用者", HASH), false, LoginState.clean(), Set.of(Role.ROLE_SALES)));
