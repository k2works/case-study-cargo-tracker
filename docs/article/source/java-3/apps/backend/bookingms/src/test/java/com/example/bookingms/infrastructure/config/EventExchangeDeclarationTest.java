...
class EventExchangeDeclarationTest {
    ...
    void namesTheUnroutableExchangeAsAgreed() {
        assertThat(com.example.bookingms.infrastructure.acl.CargoEventChannels.UNROUTABLE_EXCHANGE).isEqualTo(EventExchangeContract.UNROUTABLE_EXCHANGE);
        assertThat(com.example.bookingms.infrastructure.acl.CargoEventChannels.UNROUTABLE_QUEUE).isEqualTo(EventExchangeContract.UNROUTABLE_QUEUE);
    }
