...
public class CreateEstimateUseCase {
    ...
    private static com.example.bookingms.domain.model.valueobjects.EstimateRequirements requirementsOf(
            CreateEstimateCommand command) {
        return new com.example.bookingms.domain.model.valueobjects.EstimateRequirements(
                command.originUnLocode(), command.destinationUnLocode(),
