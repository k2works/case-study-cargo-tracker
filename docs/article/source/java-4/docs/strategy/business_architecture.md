...
rectangle {
  usecase "予約情報引き渡し" as UC1
  usecase "経路条件確認" as UC2
  usecase "航海スケジュール検索" as UC3
  usecase "経路候補算出" as UC4
  usecase "経路選択・確定" as UC5
  usecase "経路条件調整" as UC6
  usecase "経路情報紐付け" as UC7
  usecase "経路通知" as UC8
}
