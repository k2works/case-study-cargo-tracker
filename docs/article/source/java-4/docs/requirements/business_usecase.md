...
| ID | BUC 名 | 主アクター | 概要 |
|:---|:-------|:----------|:-----|
| BUC25 | 業務シミュレーション実行 | システム管理者 | 定義済みの業務シナリオ（予約から精算まで）を人手を介さずに通し、業務が端から端まで成立することを確かめる。荷主への実演、リリース前の受け入れ確認、配備直後の疎通確認で使う。**業務そのものではなく、業務が成立していることを確かめる活動**である |
...
| システム管理者 | 主アクター | 利用者の状態を確かめ、ロックを解除する | 🌊 | 中 |
| システム管理者 | 主アクター | 業務シナリオを自動で通し、どの工程まで成立しているかを確かめる | ☁️ | 中 |
