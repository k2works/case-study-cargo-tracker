...
| [開発](./development/index.md) | リリース計画、イテレーション計画、進捗管理 | cargo-tracker: **IT17 完了**（累計 140 SP・達成率 99%）。**Release 0.1 / 0.2 / 1.0 / 1.1 / 2.0 完了**、**Release 3.0（業務シミュレーション）のスコープ 19 SP を消化しきった**。リリース計画・開発戦略・IT1〜IT17 の計画/ふりかえり/完了報告書・**リリース完了報告書 6 件**（0.1・0.2・1.0・1.1・2.0・3.0） |
| [運用](./operation/index.md) | 環境構築、デプロイ、運用手順の整理 | `index.md` を整備済み |
| [レビュー](./review/index.md) | 分析・開発レビュー結果の記録 | 19 件作成済み（分析 1 件 + cargo-tracker 18 件。設計レビューと IT1〜IT17 の実装レビュー） |
| [ADR](./adr/index.md) | Architecture Decision Records の管理 | cargo-tracker: 21 件作成済み（IT17 で ADR-0021「知らせは押し出さず読みに行く」を追加） |
