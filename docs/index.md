...
| [開発](./development/index.md) | リリース計画、イテレーション計画、進捗管理 | IT6 まで完了（52 SP / 105 SP） |
| [運用](./operation/index.md) | 環境構築、デプロイ、運用手順の整理 | `index.md` を整備済み |
| [レビュー](./review/index.md) | 分析・開発レビュー結果の記録 | 8 件作成済み |
| [ユーザーマニュアル](./manual/index.md) | 業務担当者向けの操作手引き（画面キャプチャは自動生成） | 6 章作成済み |
| [ADR](./adr/index.md) | Architecture Decision Records の管理 | 22 件作成済み |
