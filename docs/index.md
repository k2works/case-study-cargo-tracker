...
| [ユーザーマニュアル](./manual/index.md) | 利用者向けの操作手順（ログイン・荷主管理・貨物予約） | [UI 設計](./design/ui_design.md) |
...
| [開発](./development/index.md) | リリース計画、イテレーション計画、進捗管理 | **IT2 完了・IT3 計画済み**（累計 16SP / 16SP。Release 0.1 完了） |
