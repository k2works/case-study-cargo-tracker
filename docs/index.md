...
| [開発](./development/index.md) | リリース計画、イテレーション計画、進捗管理、リリース完了報告書 | **全 13 イテレーション完了（110 SP / 110 SP + バッファ TD-01 2 SP・33 US すべて実装）**・**Release 1.0 / 1.1 / 2.0 / 2.1 報告書作成済み**・**Release 2.2（業務シミュレーション・US34〜US37・16 SP）完了（`java/take-7/v2.2.0`）** |
| [運用](./operation/index.md) | 環境構築、デプロイ、運用手順の整理 | `index.md` を整備済み |
| [レビュー](./review/index.md) | 分析・開発レビュー結果の記録 | 18 件作成済み |
| [ユーザーマニュアル](./manual/index.md) | 業務担当者向けの操作手引き（画面キャプチャは自動生成） | 16 章作成済み（00〜15） |
| [ADR](./adr/index.md) | Architecture Decision Records の管理 | 32 件作成済み |
