...
| [開発](./development/index.md) | リリース計画、イテレーション計画、進捗管理、リリース完了報告書 | **IT10 まで完了（88 SP / 105 SP）**・Release 1.0 報告書作成済み・Release 1.1 完了・**IT11 計画済み** |
| [運用](./operation/index.md) | 環境構築、デプロイ、運用手順の整理 | `index.md` を整備済み |
| [レビュー](./review/index.md) | 分析・開発レビュー結果の記録 | 12 件作成済み |
| [ユーザーマニュアル](./manual/index.md) | 業務担当者向けの操作手引き（画面キャプチャは自動生成） | 12 章作成済み（00〜11） |
