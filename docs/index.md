...
| [開発](./development/index.md) | リリース計画、イテレーション計画、進捗管理、リリース完了報告書 | **IT12 まで完了（105 SP / 110 SP）**・**Release 1.0 / 1.1 報告書作成済み**・**Release 2.0 完了**（報告書は未作成） |
...
| [ADR](./adr/index.md) | Architecture Decision Records の管理 | 28 件作成済み |
