...
| [開発](./development/index.md) | リリース計画、イテレーション計画、進捗管理 | **IT18 完了**（累計 117SP / 117SP）。**Release 2.1（見積）に着手し、US01 で最後の未実装 BC（Estimation）が揃った**。Release 2.0（精算）は [v2.0.0](./development/release_report-2_0_0.md) で完成済み |
